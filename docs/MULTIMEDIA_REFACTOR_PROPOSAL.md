...
状态：已进入分批实施。本文保留完整目标，不代表每项均已实现；实际支持范围见 [实施说明](MULTIMEDIA_IMPLEMENTATION.md)。不授权部署或构建 APK。

2026-09-04 设计修订：以用户随后提供的界面参考为准，当前导航采用「影视 / 直播 / 阅读 / 听书 / 来源」，中性深色与蓝色强调。下文原始导航与绿色建议不再作为当前 UI 实施标准。
